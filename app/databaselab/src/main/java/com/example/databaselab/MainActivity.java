...
public class MainActivity extends AppCompatActivity {
    ...
    private com.example.databaselab.MyDatabaseHelper dbHelper;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(com.example.databaselab.R.layout.activity_main);

        dbHelper = new com.example.databaselab.MyDatabaseHelper(this);
